...
#**********指定参数：
target_id = 45   #要爬取google scholar 主页上的第几篇(从0开始）
...
def open_browser():         #打开浏览器
    ...
    options.add_argument(r"--user-data-dir=C:\Users\yuxiao\AppData\Local\Google\Chrome\User Data")  # e.g. C:\Users\You\AppData\Local\Google\Chrome\User Data
