...
执行步骤：
1. 删除./data/下所有json文件，配置./config.json中的scholar_id
2. 运行01_article.py
3. 确定target_id，运行02_citation.py, 03_clear.py
4. 确定他引统计文件命名方式file_path， 运行04_author.py
5. 根据要找的paper数量，循环1-4，最终在./paper/all_citation/生成对应paper的引用统计。运行04.5_fellow.py
---
